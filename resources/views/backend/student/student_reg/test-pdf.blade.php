        ...
        <div class="col-md-12">
            ...
            <table width="80%">
                ...
                <tr>
                    ...
                    <td width="33%" class="text-center"><img src="{{url('public/upload/images/abc_school.png)}}" style="width: 100px;height: 100px "></td>
                    <td class="text-center" width="63%">
                        <h4><strong>Abc School</strong></h4>
                        <h4><strong>Dhaka,SanirAkra</strong></h4>
                        <h4><strong>ibf-bd.org</strong></h4>
                    </td>
                    <td  class="text-center"><img src="{{url('public/upload/images/student_images'.$details['student']['image'])}}" style="width: 100px;height: 100px "></td>
                </tr>
